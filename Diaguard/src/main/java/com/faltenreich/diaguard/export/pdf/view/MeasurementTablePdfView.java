...
public class MeasurementTablePdfView extends Table {

    private static final String TAG = MeasurementTablePdfView.class.getSimpleName();
    ...
    public MeasurementTablePdfView(PdfExportCache cache, float width) {
        super();
        this.cache = cache;
        this.width = width;
        init();
