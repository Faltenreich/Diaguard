...
import com.faltenreich.diaguard.ui.list.adapter.FoodEditableAdapter;
...
import com.faltenreich.diaguard.data.event.ui.FoodEatenRemovedEvent;
import com.faltenreich.diaguard.data.event.ui.FoodEatenUpdatedEvent;
...
public class FoodInputView extends LinearLayout {
    ...
    public boolean isValid() {
        ...
        if (StringUtils.isBlank(input) && !adapter.hasInput()) {
            ...
            isValid = PreferenceHelper.getInstance().isValueValid(valueInput.getInputView(), Measurement.Category.MEAL);
        }
        return isValid;
    }
