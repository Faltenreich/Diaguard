 ...
 */
public class EntryOrmLiteDao extends BaseDao<Entry> {

    private static final String TAG = EntryOrmLiteDao.class.getSimpleName();

    private static EntryOrmLiteDao instance;

    public static EntryOrmLiteDao getInstance() {
        if (instance == null) {
            instance = new EntryOrmLiteDao();
        }
        return instance;
    }

    private EntryOrmLiteDao() {
        super(Entry.class);
    }
