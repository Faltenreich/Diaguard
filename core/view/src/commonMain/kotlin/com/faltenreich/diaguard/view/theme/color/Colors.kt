package com.faltenreich.diaguard.view.theme.color
...
object Colors {
    ...
    val surfaceDimLight = Color(0xFFD4D4D4)
    val surfaceBrightLight = Color(0xFFFFFFFF)
    val surfaceContainerLowestLight = Color(0xFFDFDFDF)
    val surfaceContainerLowLight = Color(0xFFE7E7E7)
    val surfaceContainerLight = Color(0xFFF3F3F3)
    val surfaceContainerHighLight = Color(0xFFF7F7F7)
    ...
    val outlineVariantDark = Color(0xFF555859)
    ...
    val surfaceContainerDark = Color(0xFF313131)
    val surfaceContainerHighDark = Color(0xFF393939)
