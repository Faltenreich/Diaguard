...
class MockImport(
    ...
    override operator fun invoke() {
        ...
        val bloodSugarTypeId = measurementTypeRepository.create(name = getString(MR.strings.blood_sugar), key = MeasurementType.PredefinedKey.BLOOD_SUGAR, sortIndex = 0, propertyId = bloodSugarPropertyId)
        ...
        val insulinBolusTypeId = measurementTypeRepository.create(name = getString(MR.strings.bolus), key = MeasurementType.PredefinedKey.INSULIN_BOLUS, sortIndex = 0, propertyId = insulinPropertyId)
        ...
        val insulinCorrectionTypeId = measurementTypeRepository.create(name = getString(MR.strings.correction), key = MeasurementType.PredefinedKey.INSULIN_CORRECTION, sortIndex = 1, propertyId = insulinPropertyId)
        ...
        val insulinBasalTypeId = measurementTypeRepository.create(name = getString(MR.strings.basal), key = MeasurementType.PredefinedKey.INSULIN_BASAL, sortIndex = 2, propertyId = insulinPropertyId)
        ...
        val mealTypeId = measurementTypeRepository.create(name = getString(MR.strings.meal), key = MeasurementType.PredefinedKey.MEAL, sortIndex = 0, propertyId = mealPropertyId)
        ...
        val activityTypeId = measurementTypeRepository.create(name = getString(MR.strings.activity), key = MeasurementType.PredefinedKey.ACTIVITY, sortIndex = 0, propertyId = activityPropertyId)
        ...
        val hbA1cTypeId = measurementTypeRepository.create(name = getString(MR.strings.hba1c), key = MeasurementType.PredefinedKey.HBA1C, sortIndex = 0, propertyId = hbA1cPropertyId)
        ...
        val weightTypeId = measurementTypeRepository.create(name = getString(MR.strings.weight), key = MeasurementType.PredefinedKey.WEIGHT, sortIndex = 0, propertyId = weightPropertyId)
        ...
        val pulseTypeId = measurementTypeRepository.create(name = getString(MR.strings.pulse), key = MeasurementType.PredefinedKey.PULSE, sortIndex = 0, propertyId = pulsePropertyId)
        ...
        val pressureSystolicTypeId = measurementTypeRepository.create(name = getString(MR.strings.systolic), key = MeasurementType.PredefinedKey.BLOOD_PRESSURE_SYSTOLIC, sortIndex = 0, propertyId = pressurePropertyId)
        ...
        val pressureDiastolicTypeId = measurementTypeRepository.create(name = getString(MR.strings.diastolic), key = MeasurementType.PredefinedKey.BLOOD_PRESSURE_DIASTOLIC, sortIndex = 0, propertyId = pressurePropertyId)
        ...
        val oxygenSaturationTypeId = measurementTypeRepository.create(name = getString(MR.strings.oxygen_saturation), key = MeasurementType.PredefinedKey.OXYGEN_SATURATION, sortIndex = 0, propertyId = oxygenSaturationPropertyId)
