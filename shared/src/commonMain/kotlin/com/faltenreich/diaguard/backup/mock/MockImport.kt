...
class MockImport(
    ...
    override operator fun invoke() {
        val bloodSugarPropertyId = measurementPropertyRepository.create(name = getString(MR.strings.blood_sugar), key = MeasurementProperty.Key.BLOOD_SUGAR, icon = "\uD83E\uDE78", sortIndex = 0)
        val bloodSugarTypeId = measurementTypeRepository.create(name = getString(MR.strings.blood_sugar), key = MeasurementType.Key.BLOOD_SUGAR, sortIndex = 0, propertyId = bloodSugarPropertyId)
        ...
        val insulinPropertyId = measurementPropertyRepository.create(name = getString(MR.strings.insulin), key = MeasurementProperty.Key.INSULIN, icon = "\uD83D\uDC89", sortIndex = 1)
        val insulinBolusTypeId = measurementTypeRepository.create(name = getString(MR.strings.bolus), key = MeasurementType.Key.INSULIN_BOLUS, sortIndex = 0, propertyId = insulinPropertyId)
        ...
        val insulinCorrectionTypeId = measurementTypeRepository.create(name = getString(MR.strings.correction), key = MeasurementType.Key.INSULIN_CORRECTION, sortIndex = 1, propertyId = insulinPropertyId)
        ...
        val insulinBasalTypeId = measurementTypeRepository.create(name = getString(MR.strings.basal), key = MeasurementType.Key.INSULIN_BASAL, sortIndex = 2, propertyId = insulinPropertyId)
        ...
        val mealPropertyId = measurementPropertyRepository.create(name = getString(MR.strings.meal), key = MeasurementProperty.Key.MEAL, icon = "\uD83C\uDF5E", sortIndex = 2)
        val mealTypeId = measurementTypeRepository.create(name = getString(MR.strings.meal), key = MeasurementType.Key.MEAL, sortIndex = 0, propertyId = mealPropertyId)
        ...
        val activityPropertyId = measurementPropertyRepository.create(name = getString(MR.strings.activity), key = MeasurementProperty.Key.ACTIVITY, icon = "\uD83C\uDFC3", sortIndex = 3)
        val activityTypeId = measurementTypeRepository.create(name = getString(MR.strings.activity), key = MeasurementType.Key.ACTIVITY, sortIndex = 0, propertyId = activityPropertyId)
        ...
        val hbA1cPropertyId = measurementPropertyRepository.create(name = getString(MR.strings.hba1c), key = MeasurementProperty.Key.HBA1C, icon = "%", sortIndex = 4)
        val hbA1cTypeId = measurementTypeRepository.create(name = getString(MR.strings.hba1c), key = MeasurementType.Key.HBA1C, sortIndex = 0, propertyId = hbA1cPropertyId)
        ...
        val weightPropertyId = measurementPropertyRepository.create(name = getString(MR.strings.weight), key = MeasurementProperty.Key.WEIGHT, icon = "\uD83C\uDFCB", sortIndex = 5)
        val weightTypeId = measurementTypeRepository.create(name = getString(MR.strings.weight), key = MeasurementType.Key.WEIGHT, sortIndex = 0, propertyId = weightPropertyId)
        ...
        val pulsePropertyId = measurementPropertyRepository.create(name = getString(MR.strings.pulse), key = MeasurementProperty.Key.PULSE, icon = "\uD83D\uDC9A", sortIndex = 6)
        val pulseTypeId = measurementTypeRepository.create(name = getString(MR.strings.pulse), key = MeasurementType.Key.PULSE, sortIndex = 0, propertyId = pulsePropertyId)
        ...
        val pressurePropertyId = measurementPropertyRepository.create(name = getString(MR.strings.pressure), key = MeasurementProperty.Key.BLOOD_PRESSURE, icon = "⛽", sortIndex = 7)
        val pressureSystolicTypeId = measurementTypeRepository.create(name = getString(MR.strings.systolic), key = MeasurementType.Key.BLOOD_PRESSURE_SYSTOLIC, sortIndex = 0, propertyId = pressurePropertyId)
        ...
        val pressureDiastolicTypeId = measurementTypeRepository.create(name = getString(MR.strings.diastolic), key = MeasurementType.Key.BLOOD_PRESSURE_DIASTOLIC, sortIndex = 0, propertyId = pressurePropertyId)
        ...
        val oxygenSaturationPropertyId = measurementPropertyRepository.create(name = getString(MR.strings.oxygen_saturation), key = MeasurementProperty.Key.OXYGEN_SATURATION, icon = "O²", sortIndex = 8)
        val oxygenSaturationTypeId = measurementTypeRepository.create(name = getString(MR.strings.oxygen_saturation), key = MeasurementType.Key.OXYGEN_SATURATION, sortIndex = 0, propertyId = oxygenSaturationPropertyId)
