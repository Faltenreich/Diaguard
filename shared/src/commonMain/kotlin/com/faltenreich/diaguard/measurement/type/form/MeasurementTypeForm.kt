        ...
        is MeasurementTypeFormViewState.Loaded -> {
            Column(modifier = modifier.verticalScroll(rememberScrollState())) {
                ...
                TextCheckbox(
                    ...
                    onCheckedChange = {
                        viewModel.dispatchIntent(
                            MeasurementTypeFormIntent.EditIsValueRangeHighlighted(
                                it
                            )
                        )
                    },
                ...
                TextInput(
                    ...
                    onInputChange = {
                        viewModel.handleIntent(
                            MeasurementTypeFormIntent.EditValueRangeMinimum(
                                it
                            )
                        )
                    },
                ...
                TextInput(
                    ...
                    onInputChange = {
                        viewModel.handleIntent(
                            MeasurementTypeFormIntent.EditValueRangeLow(
                                it
                            )
                        )
                    },
                ...
                TextInput(
                    ...
                    onInputChange = {
                        viewModel.handleIntent(
                            MeasurementTypeFormIntent.EditValueRangeTarget(
                                it
                            )
                        )
                    },
                ...
                TextInput(
                    ...
                    onInputChange = {
                        viewModel.handleIntent(
                            MeasurementTypeFormIntent.EditValueRangeHigh(
                                it
                            )
                        )
                    },
                ...
                TextInput(
                    ...
                    onInputChange = {
                        viewModel.handleIntent(
                            MeasurementTypeFormIntent.EditValueRangeMaximum(
                                it
                            )
                        )
                    },
